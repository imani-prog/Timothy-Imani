export const experience = [
  {
    ...
    points: [
      'Underwent intensive full-stack software engineering training and practical development covering the complete software development lifecycle, from requirements and system design to implementation, testing, deployment, and maintenance, with hands-on exposure to backend engineering, frontend development, databases, QA, DevOps, and cloud infrastructure.',
      
      'Developed and integrated enterprise applications using Java, Spring Boot, React, PostgreSQL, and MySQL, building RESTful APIs, implementing authentication and role-based access control, handling validation and exceptions, integrating frontend interfaces with backend services, and working with relational database schemas, queries, relationships, and constraints.',
      
      'Applied practical software quality and DevOps practices using Postman, Git, GitHub, Docker, and Agile workflows, participating in API testing, debugging, code reviews, pair programming, task planning, and collaborative development while gaining experience packaging applications into containerized environments.',
