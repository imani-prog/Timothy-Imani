...
export default function Projects() {
  return (
    <section id="projects" className="py-20 px-5 sm:px-8 bg-white font-serif">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-sm sm:text-base text-slate-600 max-w-2xl mx-auto mb-12">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-slate-300 text-slate-700 font-medium hover:bg-slate-100 transition-colors"
          >
            <img
