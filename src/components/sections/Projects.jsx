...
export default function Projects() {
  return (
    <section id="projects" className="py-20 px-5 sm:px-8 bg-white dark:bg-slate-900">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-12">
          As a junior professional, I've worked on projects involving database
          management, data engineering, and software development. My
          experience includes automating data workflows, building interactive
          systems, and creating responsive websites with efficient back-end
          processes and smooth database integration.
        </p>
